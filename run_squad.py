...
def convert_examples_to_features(examples, sp_model, max_seq_length,
    ...
    for (example_index, example) in enumerate(examples):
        ...
        for (doc_span_index, doc_span) in enumerate(doc_spans):
            print("doc_span", doc_span_index, doc_span)
            tokens = []
            token_is_max_context = {}
            segment_ids = []
            p_mask = []
...
#             print("--------------InputFeatures-------------------")
#             # unique id of a qa pair
#             print("unique_id", unique_id)
            
#             print("feat_example_index", feat_example_index)
#             # split the doc into several spans, a new span starts from a stride later from previous span
#             print("doc_span_index", doc_span_index)
#             print("span_is_impossible", span_is_impossible)
#             print("cur_tok_start_to_orig_index", cur_tok_start_to_orig_index)
#             print("cur_tok_end_to_orig_index", cur_tok_end_to_orig_index)
#             print("token_is_max_context", token_is_max_context)
#             print("input_ids", input_ids)
#             print("input_mask", input_mask)
#             print("p_mask", p_mask)
#             print("segment_ids", segment_ids)
#             print("paragraph_len", paragraph_len)
